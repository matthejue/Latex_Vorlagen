...
\newcommand{\titlesecond}{Titel der Präsentation}
\newcommand{\subtitlesecond}{Untertitel der Präsentation}
\newcommand{\type}{
  Art der Präsentation\\[-0.25cm]
  \rule{8cm}{0.1mm}
}
\newcommand{\authorsecond}{Autor der Präsentation}
...
\newcommand{\institutesecond}{Name des Instituts}
\newcommand{\datesecond}{\today}
% \logo{\includegraphics[height=0.5cm]{./figures/logo.png}}

\newcommand{\lehrstuhl}{Lehrstuhl für X}
